...
Status: **AWAITING OPERATOR APPROVAL** (design presented for review; no code until approved).
...
1. `spacedRepetition.ts` + exhaustive unit tests (pure module; no wiring). **Safe checkpoint.**
