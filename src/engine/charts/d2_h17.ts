...
// Transcribed from docs/sources/verified-charts-transcription.md § 2D H17
// Columns are dealer 2 3 4 5 6 7 8 9 10 A. Actions: H S Dh Ds P Ph Rh Rs Rp.
const H = 'H',
  S = 'S',
  Dh = 'Dh',
  Ds = 'Ds',
...
// HARD totals 4..21. Columns: dealer 2 3 4 5 6 7 8 9 10 A
...
// SOFT totals 13..21 (A+2 through A+10). Columns: dealer 2 3 4 5 6 7 8 9 10 A
...
// PAIRS: 2 3 4 6 7 8 9 A. Columns: dealer 2 3 4 5 6 7 8 9 10 A
// Note: 8,8vA is 'Rp' (LEGEND DIFFERENCE: surrender if DAS not allowed, split if DAS allowed)
